...
public class NavigationTaskRepeat : ExperimentTask
{
    ...
    public override bool updateTask()
    {
        ...
        var playerBorderDistances2 = new Dictionary<string, float>();
        foreach (GameObject borderObject in borderObjects2)
        {
            ...
            playerBorderDistances2.Add(borderObject.name, player2borderDist);
        ...
        var closestBorder = playerBorderDistances2.OrderBy(kvp => kvp.Value).First();
